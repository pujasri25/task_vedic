...
class BookingsListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('My Bookings', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                    ...
                    children: ['All', 'Pending', 'Confirmed', 'Completed', 'Cancelled'].map((status) {
                      ...
                      return Padding(
                        ...
                        child: FilterChip(
                          ...
                          onSelected: (val) {
                            context.read<BookingBloc>().add(FilterBookingsEvent(query: textController.text, statusFilter: status));
                          },
                        ),
                      );
                    }).toList(),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      child: Text(item.customerName[0], style: const TextStyle(color: Color(0xFF3B137B), fontWeight: FontWeight.bold)),
                                    ),
                                            ...
                                            children: [
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Text(item.customerName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                                                    ),
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(item.serviceName, style: const TextStyle(fontSize: 14, color: Colors.black87, fontWeight: FontWeight.w500)),
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(top: 4.0),
                                                    child: Text('₹${item.totalAmount.toInt()}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF3B137B))),
                                                  ),
                                                  const SizedBox(height: 4),
